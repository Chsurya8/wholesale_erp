...
🚀 Features
✔ Add, view, and delete products ✔ Manage customer details ✔ Create and track orders ✔ Automatic stock updates ✔ Search products by name ✔ Sales analytics (monthly + top products) ✔ Sidebar dashboard UI
...
http://127.0.0.1:5000
👨‍💻 Author
Surya GitHub: https://github.com/Chsurya8
